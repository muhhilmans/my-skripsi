<x-modal name="createTaskModal" focusable>
    <div class="p-6">
        <form action="#" method="post">
            @csrf
            <!-- Modal Header -->
            <div class="flex justify-between items-center border-b pb-3">
                <h2 class="text-xl font-semibold">{{ __('Tambah Tugas') }}</h2>
                <button x-on:click="$dispatch('close-modal', 'createTaskModal')" class="text-gray-500 hover:text-gray-700">
            ...
            <div class="mt-4">
                <div>
                    <x-input-label for="title" :value="__('Judul Tugas')" required />
            ...
            <div class="flex justify-end items-center mt-4 border-t pt-3">
                <x-secondary-button
                    x-on:click="$dispatch('close-modal', 'createTaskModal')">{{ __('Batal') }}</x-secondary-button>
