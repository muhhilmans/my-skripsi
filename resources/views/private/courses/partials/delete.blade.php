<x-modal name="deleteModal{{ $course->id }}" focusable>
    <div class="p-6">
        <form action="{{ route('courses.destroy', $course->id) }}" method="post">
            ...
            <div class="flex justify-between items-center border-b pb-3">
                ...
                <button type="button" x-on:click="$dispatch('close-modal', 'deleteModal{{ $course->id }}')" class="text-gray-500 hover:text-gray-700">
            ...
            <!-- Modal Body -->
            <div class="mt-4">
                <p>Apakah Anda yakin menghapus tingkat ini?</p>
            ...
            <div class="flex justify-end items-center mt-4 border-t pt-3">
                <x-secondary-button
                    x-on:click="$dispatch('close-modal', 'deleteModal{{ $course->id }}')">{{ __('Batal') }}</x-secondary-button>
